...
const socialLinks = [
  {
    label: 'Twitter',
    href: 'https://twitter.com/trustfiti',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/trustfiti',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/company/trustfiti',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/trustfiti',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white">
                Trust<span className="text-emerald-400">Fiti</span>
              </span>
            </div>
